"""
This module contains a function that prints the current time in HH:MM:SS format.
"""
...
class TestPrintWithTime(unittest.TestCase):
    """
    This class contains tests for a function that prints the current time.
    """

    @patch("builtins.print")
    @patch("datetime.datetime")
    def test_print_with_time(self, mock_datetime: Any, mock_print: Any) -> None:
        """
